              ...
              <>
                ...
                <div className="relative" ref={userMenuRef}>
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-blue-50 hover:bg-blue-100 text-blue-700 font-semibold rounded-lg border border-blue-200 transition"
                  >
                    <div className="w-8 h-8 flex items-center justify-center bg-blue-200 text-blue-700 rounded-full font-bold">
          ...
          {user ? (
            <>
              ...
              <div className="bg-blue-50 border-b border-blue-100 px-6 py-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 flex items-center justify-center bg-blue-200 text-blue-700 rounded-full font-bold text-lg">
                    {user.username.charAt(0).toUpperCase()}
                  </div>
                  <div>
              ...
              <div className="flex flex-col space-y-2 px-6 py-4">
                <Link
                  to="/historial"
                  className="flex items-center gap-2 px-4 py-3 text-blue-600 font-semibold hover:bg-blue-50 rounded-lg transition"
                ...
                <Link
                  to="/editar-perfil"
                  className="flex items-center gap-2 px-4 py-3 text-blue-700 hover:bg-blue-50 rounded-lg transition"
                  onClick={() => setOpenMobileMenu(false)}
                >
                  <svg
                    className="w-5 h-5"
              ...
              <div className="border-t px-6 py-4">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-red-50 text-red-600 font-semibold hover:bg-red-100 rounded-lg transition"
                >
                  <svg
                    className="w-5 h-5"
                    fill="none"
            ...
            <>
              <div className="flex flex-col space-y-3 px-6 py-6">
                <Link
                  to="/login"
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition text-center"
                  onClick={() => setOpenMobileMenu(false)}
                >
                  Iniciar Sesión
                </Link>
                <Link
                  to="/register"
                  className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-lg transition text-center"
                  onClick={() => setOpenMobileMenu(false)}
                >
                  Registrarse
                </Link>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-4">
            ...
            {/* Solo mostrar Iniciar Sesión si el usuario NO está logeado */}
            {!user && (
              <Link
                to="/login"
